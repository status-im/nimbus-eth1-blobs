...
ttd=${NIMBUS_SESSION_TTD:-1000000000000}

# May be set to 1 for a single peer to be enough
min_peers=${NIMBUS_SESSION_MIN_PEERS:-2}
...
find_prefix="`dirname $0` . .. ../.. nimbus-eth1 nimbus-eth1-blobs"
